...
namespace ET.Client
{
    ...
    public static partial class LoginPanelComponentSystem
    {
        ...
        private static void UIBind(this LoginPanelComponent self)
        {
            ...
            self.u_ComInputAccount = self.UIBase.ComponentTable.FindComponent<UnityEngine.UI.InputField>("u_ComInputAccount");
            self.u_ComInputPassword = self.UIBase.ComponentTable.FindComponent<UnityEngine.UI.InputField>("u_ComInputPassword");
