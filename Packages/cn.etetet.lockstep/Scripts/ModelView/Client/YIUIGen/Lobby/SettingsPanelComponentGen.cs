...
namespace ET.Client
{
    ...
    public partial class SettingsPanelComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "Lobby";
        public const string ResName = "SettingsPanel";
        ...
        public const string OnEventCloseInvoke = "SettingsPanelComponent.OnEventCloseInvoke";
        public UIEventP0 u_EventWindowDrag;
        public UIEventHandleP0 u_EventWindowDragHandle;
        public const string OnEventWindowDragInvoke = "SettingsPanelComponent.OnEventWindowDragInvoke";
