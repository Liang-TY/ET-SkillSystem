...
namespace ET
{
    ...
    public static class UBridgeEditorHost
    {
        ...
        private static void EnsureInitialized()
        {
            ...
            // EnterPlay/ExitPlay 已禁用：进 Play 时 ET.Model.dll 被删除，UBridge 会暂停，
            // CLI 无法在 Play 期间工作，因此不允许通过指令进入/退出 Play 模式。
            ...
            RegisterHandler("YIUICreateView", UBridgeYIUICreateViewHandler.Handle);
            RegisterHandler("YIUICreateAllView", UBridgeYIUICreateAllViewHandler.Handle);
            RegisterHandler("YIUICreateUIView", UBridgeYIUICreateUIViewHandler.Handle);
